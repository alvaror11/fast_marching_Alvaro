...
void compute_2d_trajectory(){
    ...
    print_memory_usage("After initial Matrix allocation");
    ...
    print_memory_usage("Before gradient");
    ...
    print_memory_usage("After gradient");
    ...
    print_memory_usage("After initializing trajectory");
    ...
    print_memory_usage("Trayectory finished");
    
    print_memory_usage("before freeing memory");
    // Liberar memoria    
    free(output_T);
    free(matriz);
    ...
    free(last_point);
    free(traj);
    print_memory_usage("After freeing memory");
...
void compute_3d_trajectory(){
    ...
    print_memory_usage("After surrounded 3D map creation");
    //Create velocities map
    double* obstacle_distance_map = velocities_map3D(matriz, size_map, distance_threshold);
    print_memory_usage("After velocities_map3D call");
    ...
    print_memory_usage("After MSFM computation");
    ...
    print_memory_usage("After gradient computation");
    ...
    print_memory_usage("After first tray point");
    while (finished == false){
        // Obtener las coordenadas del último punto de la trayectoria
    ...
    print_memory_usage("After finishing the trayectory");
...
int main() {
    ...
    if (dimensions_prob == 3){
        remove("./Archivos/memory_log.txt");
